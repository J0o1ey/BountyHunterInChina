...
本项目采用 [知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh)（CC BY-NC-SA 4.0）© J0o1ey。

简单来说：任何人都可以在**非商业**目的下自由转载、修改和翻译本项目文章，但必须保留原作者署名，且衍生作品需以相同协议发布。**如需商业使用，须事先取得作者书面授权。** 中文原版为权威版本，英文版为社区翻译参考。
